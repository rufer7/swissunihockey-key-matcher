...
public class KeyMatcherTest {
    ...
    public void findMatchesForTwoTeamsAndOneDateFindsExpectedMatches() {
        ...
        assertEquals(createExpectedMatchingResult().getMatchesPerCombination(), matchingResult.getMatchesPerCombination());
    }

    private MatchingResult createExpectedMatchingResult() {
